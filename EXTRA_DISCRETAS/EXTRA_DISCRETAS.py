...
# Carga la imagen (debe estar en la misma carpeta que este archivo)
image = Image.open("imagen.png").resize((100, 100))   # Cambia 'ejemplo.png' por el nombre de tu imagen
